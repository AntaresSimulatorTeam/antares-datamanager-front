...
export const COMMON_CLASSES = 'flex items-center bg-transparent rounded-xs cursor-pointer';

export const FOCUS_CLASSES = 'focus-visible:outline focus-visible:outline-1 ';

export const VARIANT_CLASSES = {
  default: 'text-gray-700 focus-visible:outline-gray-900 hover:text-gray-800',
  danger: 'text-gray-700 focus-visible:outline-gray-900 hover:bg-error-600 hover:text-gray-w',
  white: 'text-gray-w focus-visible:outline-gray-100 hover:text-gray-100 ', // Temporary variant. Will be removed once the good one is designed
};
