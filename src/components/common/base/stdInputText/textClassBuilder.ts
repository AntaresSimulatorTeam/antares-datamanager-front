...
export const TEXT_CLASSES = 'text-overnote text-gray-700 inline-flex justify-between w-full';
export const COUNT_CLASSES = 'font-light';
...
export const INPUT_CLASSES =
  'w-full outline-none bg-transparent placeholder-gray-600 [appearance:textfield] [&::-webkit-outer-spin-button]:appearance-none [&::-webkit-inner-spin-button]:appearance-none';

export const COMMON_VARIANT_CLASSES = 'h-4 pl-2 pr-2 w-full outline-none border inline-flex items-center';
