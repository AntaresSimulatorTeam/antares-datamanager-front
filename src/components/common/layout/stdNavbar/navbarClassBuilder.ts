...
export const NAVBAR_BASE_CLASSES =
  'flex flex-col bg-gray-50 border-r text-left gap-2 border-gray-300 h-screen transition-all ease-out duration-300';
...
const NAVBAR_ITEM_BASE_CLASSES =
  'mx-1 flex items-center gap-1 truncate rounded p-1 text-button-s font-semibold text-gray-700';
