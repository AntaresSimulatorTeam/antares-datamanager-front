...
export const NAVBAR_BASE_CLASSES =
  'flex flex-col px-1 py-2 bg-gray-50 dark:bg-gray-800 border-r text-left gap-2 border-gray-300 h-screen transition-all ease-out duration-300';
...
const DARK_NAVBAR_ITEM_STATUS_CLASSES =
  'dark:hover:bg-gray-700 dark:hover:text-gray-200 dark:active:bg-gray-600 dark:active:text-gray-200';
...
const DARK_NAVBAR_ITEM_FOCUS_CLASSES = 'dark:focus-visible:outline-gray-w ';
...
export const NAVBAR_ITEM_CLASSES = classMerger(
  ...
  DARK_NAVBAR_ITEM_FOCUS_CLASSES,
);
