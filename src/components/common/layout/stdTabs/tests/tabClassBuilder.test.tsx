...
describe('tabItemClassBuilder function', () => {
  ...
  it('should have the hover/active classes when alwaysClickable is true and the tab is selected', () => {
    expect(
      tabItemClassBuilder('primary', true, undefined, undefined, true, true).borderClasses.includes(
        `${ACTIVE_CLASSES.active} ${ACTIVE_CLASSES.inactive}`,
      ),
    ).toBe(false);
    expect(
      tabItemClassBuilder('secondary', true, undefined, undefined, true, true).borderClasses.includes(
        `${ACTIVE_CLASSES.active} ${ACTIVE_CLASSES.inactive}`,
      ),
    ).toBe(false);
  });
