...
export interface ExpandableHypothesisTabletsHeadersProps {
...
const getExpandableHypothesisTableTSHeaders = (
  t: (value: string) => string,
  error: ErrorMessageType,
  setErrorInfo: Dispatch<SetStateAction<ErrorMessageType>>,
  studyStatus: StudyStatus | undefined,
...
export default getExpandableHypothesisTableTSHeaders;
