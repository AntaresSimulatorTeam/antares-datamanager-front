...
export const TEXT_CLASSES = 'px-0.5 py-0.25 text-overnote text-gray-700 inline-flex justify-between w-full';
export const COUNT_CLASSES = 'font-light';
export const HELPER_CLASSES = 'h-fit px-1 text-body-s text-gray-700';
